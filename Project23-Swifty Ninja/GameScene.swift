...
//
//  Created by Lydia Lu on 2024/3/14.
//
import AVFoundation
import SpriteKit
...
class GameScene: SKScene {
    ...
    func createEnemy(forceBomb: ForceBomb = .random) {
        ...
        if enemyType == 0 {
            ...
            if let emiiter = SKEmitterNode(fileNamed: "sliceFuse") {
                emiiter.position = CGPoint(x: 76, y: 64)
                enemy.addChild(emiiter)
            }
